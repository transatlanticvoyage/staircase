...
function render_footer2() {
    ...
    wp_enqueue_style('footer2-styles', $assets_url . 'css/footer-styles.css', array(), '1.0.0');
    
    // Get the footer HTML content
    $footer_file = get_template_directory() . '/footers/footer2/assets/footer-content.html';
    ...
    if (file_exists($footer_file)) {
        ...
        // Fallback footer
        ?>
        <footer class="zaramax-footer footer2">
