<?php
/**
 * Homeservice Footer 1
 * Default footer for home service businesses
 * This is the original Zaramax footer from the staircase theme
 */
...
/**
 * Render the homeservice footer 1
 */
function render_homeservice_footer_1() {
    global $wpdb;
    ...
    ?>
    <footer class="zaramax-footer homeservice-footer-1">
        <!-- Main Footer Boxes -->
