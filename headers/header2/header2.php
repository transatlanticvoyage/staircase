...
function render_header2_fallback() {
    ...
    $assets_url = get_template_directory_uri() . '/headers/header2/assets/';
    
    wp_enqueue_style('header2-styles', $assets_url . 'css/styles.css', array(), '2.0.0');
    wp_enqueue_script('header2-scripts', $assets_url . 'js/scripts.js', array('jquery'), '2.0.0', true);
    
    // Get the header HTML template
    $header_file = get_template_directory() . '/headers/header2/assets/header-template.html';
...
/**
 * Custom Walker for WordPress menu in simplified header2
 */
class Header2_Walker_Nav_Menu extends Walker_Nav_Menu {
 ...
 */
function header2_fallback_menu() {
